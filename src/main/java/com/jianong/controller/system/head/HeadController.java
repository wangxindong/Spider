package com.jianong.controller.system.head;
...
import com.jianong.service.system.fhsms.FhsmsManager;
...
import com.jianong.util.SmsUtil;
import com.jianong.util.Tools;
import com.jianong.util.Watermark;
import com.jianong.util.mail.SimpleMailSender;
...
public class HeadController extends BaseController {
	...
	public Object getFhsmsCount() {
		...
		try {
			map.put("fhsmsCount", 
					fhsmsService.findFhsmsCount(Jurisdiction.getUsername()).get("fhsmsCount").toString());//站内信未读总数
		} catch (Exception e) {
			logger.error(e.toString(), e);
		}
		return AppUtil.returnObject(pd, map);
