package com.jianong.service.system.fhsms.impl;
...
public class FhsmsService implements FhsmsManager{
	...
	@Override
	public List<PageData> findlistPageByUserName(Page page) throws Exception {
		return (List<PageData>) dao.findForList("FhsmsMapper.findlistPageByUserName", page);
	}
