package com.jianong.service.system.user.impl;
...
public class UserService implements UserManager {
	 ...
	 */
	@Override
	public List<PageData> findAllSanJiUser() throws Exception {
		return (List<PageData>) dao.findForList("UserMapper.findAllSanJiUser", null);
	}
