...
public class Const {
	...
	public static final String NO_INTERCEPTOR_PATH = ".*/((statistics)|(api/v1)|(searchEngine)|(createIndexController)|(login)|(logout)|(code)|(app)|(weixin)|(static)|(main)|(websocket)).*";	//不对匹配该值的访问路径拦截（正则）
