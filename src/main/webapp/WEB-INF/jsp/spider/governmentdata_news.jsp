	...
	<div class="main-container" id="main-container">
		...
		<div class="main-content">
			<div class="main-content-inner">
				<!-- 检索  -->
				<form action="spider/news/list.do" method="POST" name="Form" id="Form">
...
<script type="text/javascript">
    ...
    function toExcel(){
    	...
    	window.location.href='<%=basePath%>spider/excel.do?keyword='+keyword+'&begin='+lastLoginStart+'&end='+lastLoginEnd + '&type=-1' + '&ny_type_name=' + ny_type_name + '&ny_type=' + 3+ '&currentPage=' + currentPage + '&showCount=' + showCount;
    }
    ...
    // 导出一条数据
	  ...
	  function godetail(id,begintime,endtime,keyword,source,type,releasestatus,readstatus){
		  ...
		  var currentPage = "${page.currentPage}";
		  var showCount = "${page.showCount}";		  
		  window.location.href='<%=basePath%>spider/showbyid.do?id=' + id + '&begintime=' + begintime + '&endtime=' + endtime + '&keyword=' + keyword + '&source=' + source + '&type=' + type + '&type_name=' + type_name +'&ny_type_name=' + type_name + '&currentPage=' + currentPage + '&showCount=' + showCount+ '&releasestatus=' + releasestatus+ '&readstatus=' + readstatus;
	  }
