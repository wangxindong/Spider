					...
					<table style="margin-top: 5px;">
						<tr>
							...
							<td style="vertical-align:top;padding-left:2px;width: 100px;">
								 	<select class="chosen-select form-control" name="source" id="source" data-placeholder="请选择地区" style="vertical-align:top;width: 100%;">
											...
											<tr id="data_main">
                                              ...
                                              <td id="title_td" class="left">
                                                    <a style="color:#FF7F00;cursor:pointer;"
                                                        onclick="godetail('${data.id}','${pd. begintime}', '${pd.endtime }','${pd.keyword }', '${pd.source }', '${pd.type }','${data.releasestatus}','${data.readstatus}')" 
                                                       >${data.title}</a></td>
                                                    </c:when>
                                                    <c:otherwise>
                                                   <td id="title_td" class="left">
...
<script type="text/javascript">
    ...
    function toExcel(){
    	...
    	window.location.href='<%=basePath%>spider/excel.do?keyword='+keyword+'&begin='+lastLoginStart+'&end='+lastLoginEnd + '&type=-1' + '&source=' + source + '&ny_type=' + ny_type  + '&currentPage=' + currentPage + '&showCount=' + showCount;
    }
    ...
    // 导出一条数据
	  ...
	  function godetail(id,begintime,endtime,keyword,source,type,releasestatus,readstatus){
		  ...
		  var currentPage = "${page.currentPage}";
		  var showCount = "${page.showCount}";
		  window.location.href='<%=basePath%>spider/showbyid.do?id=' + id + '&begintime=' + begintime + '&endtime=' + endtime + '&keyword=' + keyword + '&source=' + source + '&type=' + type  + '&currentPage=' + currentPage + '&showCount=' + showCount+ '&releasestatus=' + releasestatus+ '&readstatus=' + readstatus;
	  }
</script>
</html>
